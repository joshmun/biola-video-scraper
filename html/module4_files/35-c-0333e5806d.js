...
t.undoManager.add()}})
n&&n(t)}
return t}},"9kyW":function(e,t,n){"use strict"
...
var f=n("tPrY")
var h,y,b,g,v
var w=(h=Object(x["a"])(),y=Object(_["l"])(f["a"]),h(b=y(b=(v=g=function(e){Object(a["a"])(n,e)
var t=Object(c["a"])(n)
function n(){var e
Object(i["a"])(this,n)
...
const t=new je["a"](e)
const n=await t.getSession()
return n.canvasUrl}var Te=n("uTvJ")
var Le=n("QV6e")
var Be=n("lcQH")
var De=n("ODXe")
var Re=n("i8i4")
...
st.defaultProps={a11yBadgeColor:"#FC5E13",a11yErrorsCount:0}
...
const Et=["trayProps"]
var At,St,jt,It
const Tt=s.a.lazy(()=>n.e(4099).then(n.bind(null,"L5Z7")))
const Lt=s.a.lazy(()=>Promise.all([n.e(3632),n.e(4066)]).then(n.bind(null,"GuXJ")))
const Bt=250
const Dt="400px"
...
let tn=0
let nn=(At=Object(B["f"])(ft,Pt),At(St=(It=jt=class e extends s.a.Component{static getByEditor(e){return qt.get(e)}constructor(t){var o
super(t)
...
this.a11yCheckerReady=Promise.all([n.e(10),n.e(21),n.e(22),n.e(26),n.e(27),n.e(4057)]).then(n.bind(null,"sOmF")).then(e=>{e.default(this.language)
this.checkAccessibility()}).catch(e=>{console.error("Failed initializing a11y checker",e)})
this.canvasUrl=Ie(this.props.trayProps)}getCode(){return this.isHidden()?this.textareaValue():this.mceInstance().getContent()}checkReadyToGetCode(e){let t=true
...
return this.canvasUrl.then(n=>ce(t,e,n))}removePlaceholders(e){const t=this.mceInstance().dom.doc.querySelector(`[data-placeholder-for="${encodeURIComponent(e)}"]`)
...
this.ltiToolFavorites.length>0&&n.e(3652).then(n.bind(null,"DiQt"))
...
return t(O(e))}}}const S="action.images.add_image"
const j="action.images.request_initial_images"
const I="action.images.request_images"
const T="action.images.receive_images"
const L="action.images.fail_images_load"
function B({id:e,filename:t,display_name:n,url:o,thumbnail_url:i},r){return{type:S,payload:{newImage:{id:e,filename:t,display_name:n,preview_url:o,thumbnail_url:i},contextType:r}}}function D(e){return{type:j,payload:{contextType:e}}}function R(e){return{type:I,payload:{contextType:e}}}function F({response:e,contextType:t}){const n=e.files,o=e.bookmark,i=e.searchString
return{type:T,payload:{files:n,bookmark:o,contextType:t,searchString:i}}}function M({error:e,contextType:t}){return{type:L,payload:{error:e,contextType:t}}}function z(){return(e,t)=>{const n=t()
return n.source.fetchImages(n).then(t=>e(F({response:t,contextType:n.contextType}))).catch(t=>e(M({error:t,contextType:n.contextType})))}}function P(){return(e,t)=>{const n=t()
const o=n.images[n.contextType]
if(!(null!==o&&void 0!==o&&o.isLoading)&&null!==o&&void 0!==o&&o.hasMore){e(R(n.contextType))
return e(z())}}}function N(){return(e,t)=>{const n=t()
e(D(n.contextType))
return e(z())}}var U=n("LixQ")
var $=n("n/1O")
const H="action.files.add_file"
const W="action.files.add_folder"
const q="action.files.receive_files"
const V="action.files.insert_file"
const G="action.files.receive_subfolders"
const K="action.files.request_files"
const Z="action.files.request_subfolders"
const Y="action.files.toggle"
const J="action.files.set_root"
function X(e){return{type:Y,id:e}}function Q({id:e,name:t,url:n,type:o,embed:i}){return{type:H,id:e,name:t,url:n,embed:i,fileType:o}}function ee(e){return{type:K,id:e}}function te(e,t){return{type:q,id:e,fileIds:t.map(e=>e.id)}}function ne(e,t){return{type:V,id:e,fileId:t}}function oe(e,t){return(n,o)=>{const i=o(),r=i.source,a=i.folders
n(ee(e))
return r.fetchFiles(t||a[e].filesUrl).then(({files:t,bookmark:o})=>{n(t.map(Q).concat(te(e,t)))
o&&n(oe(e,o))})}}function ie(e){return{type:W,id:e.id,name:e.name,parentId:e.parentId,filesUrl:e.filesUrl,foldersUrl:e.foldersUrl}}function re(e){return{type:Z,id:e}}function ae(e,t){return{type:G,id:e,folderIds:t.map(e=>e.id)}}function ce(e,t){return(n,o)=>{const i=o(),r=i.source,a=i.folders
n(re(e))
...
t(oe(o.id))}}}var le=n("s54W")
var de=n("rCsd")
var ue=n("kyQv")
var xe=n("qScw")
const _e="COMPLETE_FILE_UPLOAD"
const me="FAIL_FILE_UPLOAD"
const pe="FAIL_FOLDERS_LOAD"
const fe="FAIL_MEDIA_UPLOAD"
const he="MEDIA_UPLOAD_SUCCESS"
const ye="PROCESSED_FOLDER_BATCH"
const be="QUOTA_EXCEEDED_UPLOAD"
const ge="RECEIVE_FOLDER"
const ve="START_FILE_UPLOAD"
const we="START_LOADING"
const ke="START_MEDIA_UPLOADING"
const Ce="STOP_LOADING"
const Oe="STOP_MEDIA_UPLOADING"
const Ee="TOGGLE_UPLOAD_FORM"
function Ae(){return{type:we}}function Se(){return{type:Ce}}function je({id:e,name:t,parentId:n}){return{type:ge,id:e,name:t,parentId:n}}function Ie(e){return{type:pe,error:e}}function Te(e){l["a"].showError(e)
return{type:fe,error:e}}function Le(){return{type:he}}function Be(e){return{type:ve,file:e}}function De(e){return{type:me,error:e}}function Re(e){return{type:be,error:e}}function Fe(e){return{type:_e,results:e}}function Me(){return{type:Ee}}function ze({folders:e}){return{type:ye,folders:e}}function Pe(e){return{type:ke,payload:e}}function Ne(){return{type:Oe}}function Ue(e){return t=>{t(Pe(e))
l["a"].insertImagePlaceholder(e)}}function $e(e){return t=>{t(Ne())
l["a"].removePlaceholders(e)}}function He(e,t,n){const o=[]
o.push(Fe(e))
const i={id:e.id,name:e.display_name,url:e.preview_url,type:t.contentType,embed:Object(le["a"])(e)}
o.push(Q(i))
o.push(ne(t.parentFolderId,e.id));/^image\//.test(e["content-type"])&&o.push(B(e,n))
return o}function We(e,t){const n=Object(le["a"])(e)
if("images"===t&&Object(ue["d"])(n.type)&&"link"!==e.displayAs){var o,r
...
l["a"].insertImage(t)}else if("media"===t&&Object(ue["c"])(n.type)){var a,c
null===(a=l["a"].activeEditor())||void 0===a||null===(c=a.mceInstance())||void 0===c||c.selection.collapse()
l["a"].embedMedia({id:e.id,embedded_iframe_url:e.embedded_iframe_url,href:e.href||e.url,media_id:e.media_id,title:e.title,type:n.type,contextType:e.contextType,contextId:e.contextId,uuid:e.uuid})}else l["a"].insertLink({"data-canvas-previewable":Object(de["a"])(e["content-type"]),href:e.href||e.url,title:e.alt_text||e.display_name||e.name||e.title||e.filename,content_type:e["content-type"],embed:Object(i["a"])(Object(i["a"])({},n),{},{disablePreview:true}),target:"_blank",contextType:e.contextType,contextId:e.contextId,uuid:e.uuid},false)
return e}function qe(e){return(t,n)=>{t(Ae())
const o=n(),i=o.source,r=o.jwt,a=o.upload,c=o.host,s=o.contextId,l=o.contextType
if(e||a.folders&&0===Object.keys(a.folders).length)return i.fetchFolders({jwt:r,host:c,contextId:s,contextType:l},e).then(({folders:e,bookmark:o})=>{t(e.map(je))
const i=n(),r=i.upload
t(ze(r))
t(o?qe(o):Se())}).catch(e=>{t(Ie(e))})}}function Ve(e,t){const n=t||{},o=n.mediaObject,i=n.uploadedFile
return t=>{if(e){t(Te(e))
t($e(null===i||void 0===i?void 0:i.name))}else{const e={embedded_iframe_url:o.embedded_iframe_url,media_id:o.media_object.media_id,type:i.type,title:i.title||i.name}
t($e(i.name))
We(e,"media")
t(Le())}}}function Ge(){return(e,t)=>{const n=t(),o=n.source
if(!l["a"].mediaServerSession)return o.mediaServerSession().then(e=>{l["a"].setMediaServerSession(e)})}}function Ke(e,t={}){return(n,o)=>{const i=o(),r=i.source,a=i.jwt,c=i.host,s=i.contextId,l=i.contextType
...
return r.preflightUpload(x,{host:c,contextId:s,contextType:l,onDuplicate:d}).then(e=>r.uploadFRD(u,e))})}}function Ze(e,t){return(n,o)=>{var r
...
if("media"===e&&t.domObject)return Object(U["a"])(t.domObject,{contextId:_,contextType:m,origin:Object($["c"])(x),headers:Object($["b"])(u)},(e,t)=>{n(Ve(e,t))})
...
n(nt(e,Object(i["a"])(Object(i["a"])({},t),{},{bookmark:c})))}).catch(e=>{n($e(t.name))
...
return t}function tt(e,t){if(e&&e.response)return e.response.json().then(n=>{"file size exceeds quota"===n.message?t(Re(e)):t(De(e))}).catch(e=>t(De(e)))
if(e)return Promise.resolve().then(()=>t(De(e)))}function nt(e,t){return(n,o)=>{const r=o(),a=r.source,c=r.jwt,s=r.host,d=r.contextId,u=r.contextType
const x=t.fileReader
n(Be(t))
return a.preflightUpload(t,{jwt:c,host:s,contextId:d,contextType:u}).then(e=>a.uploadFRD(t.domObject,e)).then(e=>Ye(a,t,e)).then(e=>Je(a,e)).then(e=>Object(xe["b"])(u,d,e)).then(e=>Qe(e,t.domObject,x)).then(e=>et(t.altText,e)).then(e=>{t.isDecorativeImage&&(e.isDecorativeImage=t.isDecorativeImage)
t.displayAs&&(e.displayAs=t.displayAs)
return e}).then(e=>{n($e(t.name))
return e}).then(n=>{let o
const r=l["a"].activeEditor()
if(t.bookmark){o=r.editor.selection.getBookmark(2,true)
r.editor.selection.moveToBookmark(t.bookmark)}const a=We(Object(i["a"])({contextType:u,contextId:d},n),e)
t.bookmark&&r.editor.selection.moveToBookmark(o)
return a}).then(e=>{n(He(e,t,u))}).catch(e=>{n($e(t.name))
tt(e,n)})}}const ot="START_FLICKR_SEARCH"
const it="RECEIVE_FLICKR_RESULTS"
const rt="FAIL_FLICKR_SEARCH"
const at="TOGGLE_FLICKR_FORM"
function ct(e){return{type:ot,term:e}}function st(e){return{type:it,results:e}}function lt(e){return{type:rt,error:e}}function dt(){return{type:at}}function ut(e){return(t,n)=>{const o=n(),i=o.source,r=o.host,a=o.flickr
if(a&&!a.searching){t(ct(e))
return i.searchFlickr(e,{host:r}).then(e=>t(st(e))).catch(e=>t(lt(e)))}}}const xt="TOGGLE_NEWPAGE_FORM"
function _t(){return{type:xt}}const mt="REQUEST_INITIAL_DOCS"
const pt="REQUEST_NEXT_DOCS"
const ft="RECEIVE_DOCS"
const ht="FAIL_DOCS"
function yt(e){return{type:mt,payload:{contextType:e}}}function bt(e){return{type:pt,payload:{contextType:e}}}function gt({response:e,contextType:t,contextId:n}){const o=e.files,i=e.bookmark
return{type:ft,payload:{files:o,bookmark:i,contextType:t,contextId:n}}}function vt({error:e,contextType:t}){return{type:ht,payload:{error:e,contextType:t}}}function wt(){return(e,t)=>{const n=t()
return n.source.fetchDocs(n).then(t=>e(gt({response:t,contextType:n.contextType,contextId:n.contextId}))).catch(t=>e(vt({error:t,contextType:n.contextType})))}}function kt(){return(e,t)=>{const n=t()
const o=n.documents[n.contextType]
if(!(null!==o&&void 0!==o&&o.isLoading)&&null!==o&&void 0!==o&&o.hasMore){e(bt(n.contextType))
return e(wt())}}}function Ct(){return(e,t)=>{const n=t()
e(yt(n.contextType))
return e(wt())}}var Ot=n("eAGa")
var Et=n("NFDp")
const At="REQUEST_INITIAL_MEDIA"
const St="REQUEST_MEDIA"
const jt="RECEIVE_MEDIA"
const It="FAIL_MEDIA"
function Tt(e){return{type:At,payload:{contextType:e}}}function Lt(e){return{type:St,payload:{contextType:e}}}function Bt({response:e,contextType:t}){const n=e.files,o=e.bookmark
return{type:jt,payload:{files:n,bookmark:o,contextType:t}}}function Dt({error:e,contextType:t}){return{type:It,payload:{error:e,contextType:t}}}function Rt(){return(e,t)=>{const n=t()
e(Lt(n.contextType))
return n.source.fetchMedia(n).then(t=>e(Bt({response:t,contextType:n.contextType}))).catch(t=>e(Dt({error:t,contextType:n.contextType})))}}function Ft(){return(e,t)=>{const n=t()
const o=n.media[n.contextType]
if(!(null!==o&&void 0!==o&&o.isLoading)&&null!==o&&void 0!==o&&o.hasMore){e(Lt(n.contextType))
return e(Rt())}}}function Mt(){return(e,t)=>{const n=t()
e(Tt(n.contextType))
return e(Rt())}}function zt({media_object_id:e,title:t,subtitles:n}){return(o,i)=>{const r=i()
...
return Promise.all([a,c])}}const Pt="CHANGE_CONTEXT"
const Nt="CHANGE_CONTEXT_TYPE"
const Ut="CHANGE_CONTEXT_ID"
const $t="CHANGE_SEARCH_STRING"
const Ht="CHANGE_SORT_BY"
function Wt({contextType:e,contextId:t}){return n=>{n(qt(e))
n(Vt(t))
n({type:Pt,payload:{contextType:e,contextId:t}})}}function qt(e){return{type:Nt,payload:e}}function Vt(e){return{type:Ut,payload:e}}function Gt(e){return{type:$t,payload:e}}function Kt(e){return{type:Ht,payload:e}}const Zt="ALL_FILES_LOADING"
...
return null===(n=i.getSession)||void 0===n?void 0:n.call(i).then(t=>e(Xt(t)))}function en(e){return{loadSession:()=>e(Qt),onChangeTab:t=>e(p(t)),onChangeAccordion:t=>e(f(t)),fetchInitialPage:t=>e(A(t)),fetchNextPage:t=>e(E(t)),toggleFolder:t=>e(se(t)),fetchFolders:()=>e(qe()),fetchInitialImages:()=>e(N()),fetchNextImages:()=>e(P()),startUpload:(t,n)=>e(nt(t,n)),flickrSearch:t=>e(ut(t)),toggleFlickrForm:()=>e(dt()),toggleUploadForm:()=>e(Me()),toggleNewPageForm:()=>e(_t()),startButtonsAndIconsUpload:(t,n)=>e(Ke(t,n)),startMediaUpload:(t,n)=>e(Ze(t,n)),createMediaServerSession:()=>e(Ge()),mediaUploadComplete:(t,n)=>e(Ve(t,n)),fetchInitialDocs:()=>e(Ct()),fetchNextDocs:()=>e(kt()),fetchInitialMedia:()=>e(Mt()),fetchNextMedia:()=>e(Ft()),updateMediaObject:t=>e(zt(t)),onChangeContext:t=>e(Wt(t)),onChangeSearchString:t=>e(Gt(t)),onChangeSortBy:t=>e(Kt(t)),onAllFilesLoading:t=>e(Yt(t))}}function tn(e){const t=e.ui,n=e.containingContext,o=e.contextType,r=e.contextId,a=e.files,c=e.images,s=e.documents,l=e.media,d=e.folders,u=e.rootFolderId,x=e.flickr,_=e.upload,m=e.session,p=e.newPageLinkExpanded,f=e.all_files,h=e.jwt,y=e.host,b=e.source
const g={}
for(const t in e.collections){const n=e.collections[t]
g[t]=n}return Object(i["a"])(Object(i["a"])({containingContext:n,contextType:o,contextId:r,collections:g,files:a,images:c,documents:s,media:l,folders:d,rootFolderId:u,flickr:x,upload:_,session:m,newPageLinkExpanded:p},t),{},{all_files:f,jwt:h,host:y,source:b})}var nn=n("ANjH")
var on=function(e=""){return e}
function rn(e=false,t){switch(t.type){case _:return true
case x:case m:return false
default:return e}}function an(e=0,t){switch(t.type){case x:return 0
case d:return t.index
default:return e}}function cn(e="",t){switch(t.type){case x:case d:return""
...
var ln=function(e={},t){switch(t.type){case h:return Object(i["a"])(Object(i["a"])({},e),{},{links:[],bookmark:null,isLoading:true,hasMore:true,searchString:t.searchString})
...
function dn(e){return function(t={},n){switch(n.type){case h:case y:case b:case g:return n.key===e?ln(t,n):t
default:return t}}}var un=Object(nn["combineReducers"])({announcements:dn("announcements"),assignments:dn("assignments"),discussions:dn("discussions"),modules:dn("modules"),quizzes:dn("quizzes"),wikiPages:dn("wikiPages")})
function xn(e={},t){switch(t.type){case H:return Object(i["a"])(Object(i["a"])({},e),{},{[t.id]:{id:t.id,name:t.name,type:t.fileType,url:t.url,embed:t.embed}})
default:return e}}const _n={id:null,name:null,loadingCount:0,loading:false,requested:false,expanded:false,filesUrl:null,foldersUrl:null,parentId:null,fileIds:[],folderIds:[]}
function mn(e=_n,t){let n
switch(t.type){case W:return Object(i["a"])(Object(i["a"])({},e),{},{id:t.id,name:t.name,parentId:t.parentId,filesUrl:t.filesUrl,foldersUrl:t.foldersUrl})
case q:n=e.loadingCount-1
return Object(i["a"])(Object(i["a"])({},e),{},{loadingCount:n,loading:!!n,fileIds:e.fileIds.concat(t.fileIds)})
case V:return Object(i["a"])(Object(i["a"])({},e),{},{fileIds:e.fileIds.concat(t.fileId)})
...
case K:case Z:n=e.loadingCount+1
...
default:return e}}function pn(e={},t){switch(t.type){case W:case q:case V:case G:case K:case Z:case Y:return Object(i["a"])(Object(i["a"])({},e),{},{[t.id]:mn(e[t.id],t)})
default:return e}}function fn(e=null,t){switch(t.type){case J:return t.id
...
switch(t.type){case S:{const e=t.payload.newImage,i=e.id,r=e.filename,a=e.display_name,c=e.href,s=e.preview_url,l=e.thumbnail_url
o[n]={files:o[n].files.concat({id:i,filename:r,display_name:a,preview_url:s,thumbnail_url:l,href:s||c})}
return o}case j:o[n]={files:[],bookmark:null,isLoading:true,hasMore:true}
return o
case I:o[n].isLoading=true
return o
case T:t.payload.searchString===o.searchString&&(o[n]={files:o[n].files.concat(t.payload.files),isLoading:false,bookmark:t.payload.bookmark,hasMore:!!t.payload.bookmark})
return o
case L:o[n]={isLoading:false,error:t.payload.error}
t.payload.files&&0===t.payload.files.length&&(o[n].bookmark=null)
return o
case Pt:return o
case $t:o.searchString=t.payload
return o
default:return e}}function yn(e={},t){const n=t.payload&&t.payload.contextType
const o=Object(i["a"])({},e)
n&&!o[n]&&(o[n]={files:[],bookmark:null,isLoading:false,hasMore:true})
...
return o
case ft:o[n]={files:o[n].files.concat(t.payload.files),bookmark:t.payload.bookmark,isLoading:false,hasMore:!!t.payload.bookmark}
return o
case ht:o[n]={isLoading:false,error:t.payload.error}
t.payload.files&&0===t.payload.files.length&&(o[n].bookmark=null)
return o
case Pt:case $t:return o
...
return o
case St:o[n].isLoading=true
return o
case jt:o[n]={files:o[n].files.concat(t.payload.files),bookmark:t.payload.bookmark,isLoading:false,hasMore:!!t.payload.bookmark}
return o
case It:o[n]={isLoading:false,error:t.payload.error}
t.payload.files&&0===t.payload.files.length&&(o[n].bookmark=null)
return o
case Pt:case $t:return o
default:return e}}function gn(e=false,t){switch(t.type){case ve:return true
case me:case _e:case be:return false
default:return e}}function vn(e={},t){switch(t.type){case _e:return{}
case be:return Object(i["a"])(Object(i["a"])({},e),{},{type:t.type})
default:return e}}function wn(e=false,t){switch(t.type){case _e:return false
case Ee:return!e
default:return e}}function kn(e={},t){switch(t.type){case ge:return Object(i["a"])(Object(i["a"])({},e),{},{[t.id]:{id:t.id,name:t.name,parentId:t.parentId}})
case pe:default:return e}}function Cn(e=null,t){switch(t.type){case ge:return null===t.parentId?t.id:e
default:return e}}function On(e={},t){switch(t.type){case ye:{const e=t.folders
const n={}
for(const t in e){const o=e[t]
n[o.id]=n[o.id]||[]
if(o.parentId){n[o.parentId]=n[o.parentId]||[]
n[o.parentId].push(o.id)}}for(const t in n){const o=n[t]
o.sort((t,n)=>e[t].name.localeCompare(e[n].name))}return n}default:return e}}function En(e=false,t){switch(t.type){case we:return true
case Ce:case pe:return false
default:return e}}function An(e=false,t){switch(t.type){case we:return{loading:true,uploaded:false,error:false}
case fe:return{loading:false,uploaded:false,error:true}
case he:return{loading:false,uploaded:true,error:false}
default:return e}}var Sn=Object(nn["combineReducers"])({uploading:gn,formExpanded:wn,folders:kn,rootFolderId:Cn,folderTree:On,error:vn,loadingFolders:En,uploadingMediaStatus:An})
var jn=function(e={},t){switch(t.type){case ot:return Object(i["a"])(Object(i["a"])({},e),{},{searching:true,searchTerm:t.term})
...
default:return e}}
const In={}
function Tn(e=In,t){switch(t.type){case Jt:return Object(i["a"])(Object(i["a"])({},e),t.data)
default:return e}}var Ln=function(e=false,t){switch(t.type){case xt:return!e
default:return e}}
function Bn(e="",t){if(t.type===Nt)return t.payload
...
return e}var zn=Object(nn["combineReducers"])({ui:sn,source:on,jwt:on,host:on,containingContext:on,contextType:Bn,contextId:Dn,searchString:Rn,sortBy:Fn,all_files:Mn,collections:un,files:xn,folders:pn,rootFolderId:fn,images:hn,documents:yn,media:bn,upload:Sn,flickr:jn,session:Tn,newPageLinkExpanded:Ln})
function Pn(e){switch(e){case"course":case"courses":return"course"
case"group":case"groups":return"group"
case"user":case"users":return"user"
default:return}}var Nn=function(e={}){let t=e,n=t.source,o=t.jwt,r=t.refreshToken,a=t.host,c=t.contextType,s=t.contextId,l=t.collections,d=t.files,u=t.folders,x=t.upload,_=t.images,m=t.documents,p=t.media,f=t.flickr,h=t.newPageLinkExpanded,y=t.searchString,b=t.sortBy,g=t.all_files
c=Pn(c)
...
null==n&&(n=new $["a"]({jwt:o,refreshToken:r,host:a}))
...
var Un=n("sINF")
var $n=n("FkO2")
var Hn=function(e,t){const n=Object(nn["createStore"])(Object($n["batching"])(zn),t||Nn(e),Object(nn["applyMiddleware"])(Un["a"],$n["batch"]))
...
return n}
const Wn=["children"],qn=["children"]
function Vn(e){let t=e.children,n=Object(r["a"])(e,Wn)
return t(Object(i["a"])({onLinkClick:l["a"].insertLink,onImageEmbed:l["a"].embedImage,onMediaEmbed:l["a"].embedMedia,onFileSelect:l["a"].insertFileLink},n))}const Gn=Object(s["b"])(tn,en)(Vn)
const Kn=Object(a["createContext"])()
function Zn(e){let t=e.children,n=Object(r["a"])(e,qn)
const i=Object(a["useState"])(()=>Hn(n)),l=Object(o["a"])(i,1),d=l[0]
return c.a.createElement(s["a"],{store:d},c.a.createElement(Gn,null,e=>c.a.createElement(Kn.Provider,{value:e},t(e))))}function Yn(){const e=Object(a["useContext"])(Kn)
...
switch(e){case"ar":i=n.e(4141).then(n.bind(null,"venI"))
break
case"ca":i=n.e(4142).then(n.bind(null,"1Y6O"))
break
case"cy":i=n.e(4143).then(n.bind(null,"we+z"))
break
case"da":i=n.e(4145).then(n.bind(null,"PTiq"))
break
case"da-x-k12":i=n.e(4144).then(n.bind(null,"yNIZ"))
break
case"de":i=n.e(4146).then(n.bind(null,"S8cF"))
break
case"el":i=n.e(4147).then(n.bind(null,"FwcW"))
break
case"en":i=n.e(4212).then(n.bind(null,"NQfO"))
break
case"en-AU-x-unimelb":i=n.e(4148).then(n.bind(null,"3W0S"))
break
case"en-GB-x-ukhe":i=n.e(4149).then(n.bind(null,"KQzV"))
break
case"en-AU":i=n.e(4150).then(n.bind(null,"voS+"))
break
case"en-CA":i=n.e(4213).then(n.bind(null,"m+Mn"))
break
case"en-CY":i=n.e(4214).then(n.bind(null,"mgnU"))
break
case"en-GB":i=n.e(4151).then(n.bind(null,"nxzM"))
break
case"es":i=n.e(4152).then(n.bind(null,"2MaM"))
break
case"es-ES":i=n.e(4153).then(n.bind(null,"HM1o"))
break
case"fa-IR":i=n.e(4154).then(n.bind(null,"01hr"))
break
case"fi":i=n.e(4155).then(n.bind(null,"QFVQ"))
break
case"fr":i=n.e(4156).then(n.bind(null,"8o6s"))
break
case"fr-CA":i=n.e(4157).then(n.bind(null,"Bm8W"))
break
case"he":i=n.e(4158).then(n.bind(null,"mYM8"))
break
case"ht":i=n.e(4215).then(n.bind(null,"ZkKP"))
break
case"hu":i=n.e(4159).then(n.bind(null,"sbbs"))
break
case"hy":i=n.e(4160).then(n.bind(null,"WoYt"))
break
case"is":i=n.e(4216).then(n.bind(null,"/C+o"))
break
case"it":i=n.e(4161).then(n.bind(null,"Qvrh"))
break
case"ja":i=n.e(4162).then(n.bind(null,"XZYX"))
break
case"ko":i=n.e(4163).then(n.bind(null,"vrKU"))
break
case"mi":i=n.e(4217).then(n.bind(null,"LP6z"))
break
case"nb":i=n.e(4165).then(n.bind(null,"Uc+e"))
break
case"nb-x-k12":i=n.e(4164).then(n.bind(null,"56N6"))
break
case"nl":i=n.e(4166).then(n.bind(null,"17Or"))
break
case"nn":i=n.e(4167).then(n.bind(null,"HZtm"))
break
case"pl":i=n.e(4168).then(n.bind(null,"JcWQ"))
break
case"pt":i=n.e(4169).then(n.bind(null,"I9Ke"))
break
case"pt-BR":i=n.e(4170).then(n.bind(null,"7P9b"))
break
case"ru":i=n.e(4171).then(n.bind(null,"V5X0"))
break
case"se":i=n.e(4218).then(n.bind(null,"JKpP"))
break
case"sl":i=n.e(4172).then(n.bind(null,"h8aU"))
break
case"sv":i=n.e(4174).then(n.bind(null,"lfo/"))
break
case"sv-x-k12":i=n.e(4173).then(n.bind(null,"4MO5"))
break
case"th":i=n.e(4175).then(n.bind(null,"TDbP"))
break
case"tr":i=n.e(4176).then(n.bind(null,"V0pu"))
break
case"uk-UA":i=n.e(4177).then(n.bind(null,"yL5t"))
break
case"zh":i=n.e(4180).then(n.bind(null,"Sx0h"))
break
case"zh-Hans":i=n.e(4178).then(n.bind(null,"32vL"))
break
case"zh-Hant":i=n.e(4179).then(n.bind(null,"Iyx8"))
break
case"zh-HK":i=n.e(4181).then(n.bind(null,"v1QM"))
break
...
var A=n("CMdt")
var S=n("3Sge")
const j={contentSubtype:"all",contentType:"links",sortValue:"date_added",searchString:""}
function I(e){const t=Object(r["useState"])(e||j),n=Object(i["a"])(t,2),a=n[0],c=n[1]
...
case"files":default:return Object(m["a"])("Files")}}function L(e,t,n){const o=[a.a.createElement(b["a"].Option,{key:"links",id:"links",value:"links",renderBeforeLabel:w["a"]},Object(m["a"])("Links"))]
"course"===n&&"links"!==e&&"all"!==t&&o.push(a.a.createElement(b["a"].Option,{key:"course_files",id:"course_files",value:"course_files",renderBeforeLabel:k["a"]},T("course")))
"group"===n&&"links"!==e&&"all"!==t&&o.push(a.a.createElement(b["a"].Option,{key:"group_files",id:"group_files",value:"group_files",renderBeforeLabel:k["a"]},T("group")))
"buttons_and_icons"!==t&&o.push(a.a.createElement(b["a"].Option,{key:"user_files",id:"user_files",value:"user_files",renderBeforeLabel:k["a"]},T("links"===e||"all"===t?"files":"user")))
return o}function B(e,t,n,o,i){return"course"===i||"group"===i?a.a.createElement(b["a"],{renderLabel:a.a.createElement(v["a"],null,Object(m["a"])("Content Type")),assistiveText:Object(m["a"])("Use arrow keys to navigate options."),onChange:(t,o)=>{const i={contentType:o.value}
"links"===e&&(i.contentSubtype="all")
n(i)},value:e},L(e,t,o)):a.a.createElement(h["a"],{as:"div",borderWidth:"small",padding:"x-small small",borderRadius:"medium",width:"100%"},a.a.createElement(v["a"],null,Object(m["a"])("Content Type")),T("user",t))}function D(e){return 0===e.length||e.length>=3}function R(e){const t=e.contentType,n=e.contentSubtype,o=e.onChange,c=e.sortValue,s=e.searchString,l=e.userContextType,d=e.isContentLoading,u=e.containingContextType
const x=Object(r["useState"])(s),p=Object(i["a"])(x,2),f=p[0],w=p[1]
const k=Object(r["useState"])(0),j=Object(i["a"])(k,2),I=j[0],T=j[1]
Object(r["useEffect"])(()=>{o({contentType:t})},[])
function L(e){if(D(e)){if(I){window.clearTimeout(I)
T(0)}o({searchString:e})}}function R(e){w(e)
I&&window.clearTimeout(I)
const t=window.setTimeout(()=>L(e),250)
T(t)}function F(){R("")}const M=Object(m["a"])("Enter at least 3 characters to search")
const z=Object(m["a"])("Loading, please wait")
const P=d?z:M
return a.a.createElement(h["a"],{display:"block",direction:"column"},B(t,n,o,l,u),"links"!==t&&a.a.createElement(_["a"],{margin:"small none none none"},a.a.createElement(_["a"].Item,{grow:true,shrink:true,margin:"none xx-small none none"},a.a.createElement(b["a"],{renderLabel:a.a.createElement(v["a"],null,Object(m["a"])("Content Subtype")),assistiveText:Object(m["a"])("Use arrow keys to navigate options."),onChange:(e,t)=>{const n={contentSubtype:t.value}
"all"===n.contentSubtype?n.contentType="user_files":"buttons_and_icons"===n.contentSubtype&&(n.contentType="course_files")
o(n)},value:n},a.a.createElement(b["a"].Option,{id:"images",value:"images",renderBeforeLabel:C["a"]},Object(m["a"])("Images")),a.a.createElement(b["a"].Option,{id:"documents",value:"documents",renderBeforeLabel:O["a"]},Object(m["a"])("Documents")),a.a.createElement(b["a"].Option,{id:"media",value:"media",renderBeforeLabel:E["a"]},Object(m["a"])("Media")),e.use_rce_buttons_and_icons&&a.a.createElement(b["a"].Option,{id:"buttons_and_icons",value:"buttons_and_icons",renderBeforeLabel:C["a"]},Object(m["a"])("Buttons and Icons")),a.a.createElement(b["a"].Option,{id:"all",value:"all"},Object(m["a"])("All")))),"all"!==n&&a.a.createElement(_["a"].Item,{grow:true,shrink:true,margin:"none none none xx-small"},a.a.createElement(b["a"],{renderLabel:a.a.createElement(v["a"],null,Object(m["a"])("Sort By")),assistiveText:Object(m["a"])("Use arrow keys to navigate options."),onChange:(e,t)=>{o({sortValue:t.value})},value:c},a.a.createElement(b["a"].Option,{id:"date_added",value:"date_added"},Object(m["a"])("Date Added")),a.a.createElement(b["a"].Option,{id:"alphabetical",value:"alphabetical"},Object(m["a"])("Alphabetical"))))),a.a.createElement(h["a"],{as:"div",margin:"small none none none"},a.a.createElement(y["a"],{renderLabel:a.a.createElement(v["a"],null,Object(m["a"])("Search")),renderBeforeInput:a.a.createElement(A["a"],{inline:false}),renderAfterInput:function(){if(f)return a.a.createElement(g["a"],{screenReaderLabel:Object(m["a"])("Clear"),onClick:F,interaction:d?"disabled":"enabled",withBorder:false,withBackground:false,size:"small"},a.a.createElement(S["a"],null))
return}(),messages:[{type:"hint",text:P}],placeholder:Object(m["a"])("Search"),value:f,onChange:(e,t)=>R(t),onKeyDown:e=>{"Enter"===e.key&&L(f)},interaction:d?"readonly":"enabled"})))}R.propTypes={contentSubtype:c["string"].isRequired,contentType:Object(c["oneOf"])(["links","user_files","course_files","group_files"]).isRequired,onChange:c["func"].isRequired,sortValue:c["string"].isRequired,searchString:c["string"].isRequired,userContextType:Object(c["oneOf"])(["user","course","group"]),isContentLoading:c["bool"],containingContextType:Object(c["oneOf"])(["user","course","group"])}
var F=n("eHui")
var M=n("z7I/")
...
const O=I(),E=Object(i["a"])(O,2),A=E[0],S=E[1]
const j=Object(o["a"])({},e),T=j.bridge,L=j.editor,B=j.onTrayClosing
const D=Object(r["useCallback"])(()=>{k.current&&k.current.contains(document.activeElement)&&T.focusActiveEditor(false)
B&&B(W.globalOpenCount)
s(false)},[T,B])
Object(r["useEffect"])(()=>{T.attachController({showTrayForPlugin(e){++W.globalOpenCount
S($[e])
s(true)},hideTray(e){(e||v)&&D()}},L.id)
return()=>{T.detachController(L.id)}},[L.id,T,D,v])
Object(r["useEffect"])(()=>{h&&C.current&&!C.current.style.overscrollBehaviorY&&(C.current.style.overscrollBehaviorY="contain")},[h])
function P(){T.focusEditor(L)
y(true)}function U(){B&&B(true)}function q(){y(false)
...
o=e.containingContext.contextId}n({contextType:t,contextId:o})}}return a.a.createElement(F["a"],Object.assign({},e,{key:W.globalOpenCount,contextType:A.contextType||e.contextType}),t=>a.a.createElement(l["a"],{"data-mce-component":true,"data-testid":"CanvasContentTray",label:z(A.contentType,A.contentSubtype,t.contextType),open:c,placement:"end",size:"regular",shouldContainFocus:true,shouldReturnFocus:false,shouldCloseOnDocumentClick:false,onDismiss:D,onClose:q,onExit:U,onOpen:P,onEntered:()=>{const e=document.querySelector('[role="main"]')
let t=0
if(e){var n
...
e&&(e.style.width="")},contentRef:e=>k.current=e},c&&h?a.a.createElement(_["a"],{direction:"column",as:"div",height:Object(M["a"])(),overflowY:"hidden",tabIndex:"-1","data-canvascontenttray-content":true},a.a.createElement(_["a"].Item,{padding:"medium",shadow:"above"},a.a.createElement(_["a"],{margin:"none none medium none"},a.a.createElement(_["a"].Item,{shouldgrow:true,shouldshrink:true},a.a.createElement(u["a"],{level:"h2"},Object(m["a"])("Add"))),a.a.createElement(_["a"].Item,null,a.a.createElement(d["a"],{placement:"end",onClick:D,"data-testid":"CloseButton_ContentTray",screenReaderLabel:Object(m["a"])("Close")}))),a.a.createElement(R,Object.assign({},A,{userContextType:e.contextType,containingContextType:e.containingContext.contextType,onChange:e=>{V(e,t.onChangeContext,t.onChangeSearchString,t.onChangeSortBy)},isContentLoading:H(t),use_rce_buttons_and_icons:e.use_rce_buttons_and_icons}))),a.a.createElement(_["a"].Item,{shouldgrow:true,shouldshrink:true,margin:"xx-small xxx-small 0",elementRef:e=>C.current=e},a.a.createElement(p,null,a.a.createElement(N,Object.assign({contentType:A.contentType,contentSubtype:A.contentSubtype,sortBy:{sort:A.sortValue,order:A.sortDir},searchString:A.searchString,source:e.source,jwt:e.jwt,host:e.host,refreshToken:e.refreshToken,context:{type:e.contextType,id:e.contextId}},t))))):null))}W.globalOpenCount=0
function q(e,t,n){if(null==e.source&&null==e[t])throw new Error(`The prop \`${t}\` is marked as required in \`${n}\`, but its value is \`${e[t]}\`.`)}const V={canUploadFiles:c["bool"].isRequired,contextId:c["string"].isRequired,contextType:c["string"].isRequired,containingContext:Object(c["shape"])({contextType:c["string"].isRequired,contextId:c["string"].isRequired,userId:c["string"].isRequired}),filesTabDisabled:c["bool"],host:q,jwt:q,refreshToken:c["func"],source:Object(c["shape"])({fetchImages:c["func"].isRequired}),themeUrl:c["string"]}
const G=Object(c["shape"])(V)
W.propTypes=Object(o["a"])({bridge:Object(c["instanceOf"])(f["a"]).isRequired,editor:Object(c["shape"])({id:c["string"]}).isRequired,onTrayClosing:c["func"]},V)
W.defaultProps={canUploadFiles:false,filesTabDisabled:false,refreshToken:null,source:null,themeUrl:null}},"n/1O":function(e,t,n){"use strict"
...
n=`${e.filesUrl}?${t}${b(e.searchString)}`
...
const i={contextId:t.contextId,contextType:t.contextType,file:e,no_redirect:true,onDuplicate:t.onDuplicate}
...
switch(e){case"images":s=`&content_types=image${y(r.sort,r.dir)}${b(a)}`
break
case"media":s=`&content_types=video,audio${y(r.sort,r.dir)}${b(a)}`
break
case"documents":s=`&exclude_content_types=image,video,audio${y(r.sort,r.dir)}${b(a)}`
break
case"media_objects":s=`${y("alphabetical"===r.sort?"title":"date",r.dir)}${b(a)}`
break
default:s=b(a)}return`${this.baseUri(e,n)}?contextType=${o}&contextId=${i}${l}${s}`}}function y(e,t){let n=e
"date_added"===n?n="created_at":"alphabetical"===n&&(n="name")
return`&sort=${n}&order=${t}`}function b(e){return(null===e||void 0===e?void 0:e.length)>=3?"&search_term="+encodeURIComponent(e):""}t["a"]=h},q8CT:function(e,t,n){"use strict"
n.d(t,"a",(function(){return x}))
var o=n("VTBJ")
var i=n("1OyB")
var r=n("vuIU")
...
//# sourceMappingURL=35-c-0333e5806d.js.map